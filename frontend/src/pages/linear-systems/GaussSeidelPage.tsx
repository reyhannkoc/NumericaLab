...
export default function Page() {
  return (
    <LessonPageShell
      ...
      subtitle="Iterative solver using most-recent values"
      complexity="intermediate"
      tags={["iterative", "large-systems"]}
      moduleColor=""
      sections={SECTIONS}
    >
      <TheorySection id="theory" title="Theory">
        <p className="text-slate-300">
          Full lesson content for <strong className="text-white">Gauss-Seidel Method</strong> will be implemented here.
