...
export default function Page() {
  return (
    <LessonPageShell
      title="Jacobi Method"
      subtitle="Simultaneous iterative relaxation"
      complexity="introductory"
      tags={["iterative", "parallel"]}
      moduleColor=""
      sections={SECTIONS}
    >
      <TheorySection id="theory" title="Theory">
        <p className="text-slate-300">
          Full lesson content for <strong className="text-white">Jacobi Method</strong> will be implemented here.
