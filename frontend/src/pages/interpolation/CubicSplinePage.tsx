...
export default function Page() {
  return (
    <LessonPageShell
      ...
      subtitle="Piecewise cubic polynomials with smooth transitions"
      complexity="advanced"
      tags={["spline", "smooth"]}
      moduleColor=""
      sections={SECTIONS}
    >
      <TheorySection id="theory" title="Theory">
        <p className="text-slate-300">
          Full lesson content for <strong className="text-white">Cubic Spline Interpolation</strong> will be implemented here.
