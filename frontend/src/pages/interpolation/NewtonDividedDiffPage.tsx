...
export default function Page() {
  return (
    <LessonPageShell
      ...
      subtitle="Efficient incremental polynomial interpolation"
      complexity="intermediate"
      tags={["polynomial", "efficient"]}
      moduleColor=""
      sections={SECTIONS}
    >
      <TheorySection id="theory" title="Theory">
        <p className="text-slate-300">
          Full lesson content for <strong className="text-white">Newton Divided Differences</strong> will be implemented here.
