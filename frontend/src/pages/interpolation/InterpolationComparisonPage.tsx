...
export default function Page() {
  return (
    <LessonPageShell
      ...
      subtitle="Compare methods on the same dataset"
    ...
    >
      <TheorySection id="theory" title="Theory">
        <p className="text-slate-300">
          Full lesson content for <strong className="text-white">Interpolation Comparison</strong> will be implemented here.
