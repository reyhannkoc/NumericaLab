...
export default function Page() {
  return (
    <LessonPageShell
      ...
      subtitle="Second-order O(h²) derivative approximation"
    ...
    >
      <TheorySection id="theory" title="Theory">
        <p className="text-slate-300">
          Full lesson content for <strong className="text-white">Central Difference</strong> will be implemented here.
