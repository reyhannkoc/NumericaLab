...
export default function Page() {
  return (
    <LessonPageShell
      ...
      subtitle="Cancel leading error terms for O(h⁴) accuracy"
      complexity="advanced"
      tags={["O(h4)", "high-order"]}
      moduleColor=""
      sections={SECTIONS}
    >
      <TheorySection id="theory" title="Theory">
        <p className="text-slate-300">
          Full lesson content for <strong className="text-white">Richardson Extrapolation</strong> will be implemented here.
