...
export default function Page() {
  return (
    <LessonPageShell
      ...
      subtitle="Compare optimization methods on the same objective"
    ...
    >
      <TheorySection id="theory" title="Theory">
        <p className="text-slate-300">
          Full lesson content for <strong className="text-white">Optimization Comparison</strong> will be implemented here.
