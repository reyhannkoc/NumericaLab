...
export default function Page() {
  return (
    <LessonPageShell
      ...
      subtitle="Compare quadrature methods on the same function"
    ...
    >
      <TheorySection id="theory" title="Theory">
        <p className="text-slate-300">
          Full lesson content for <strong className="text-white">Integration Comparison</strong> will be implemented here.
