...
export default function Page() {
  return (
    <LessonPageShell
      title="Runge-Kutta 4"
      subtitle="Classic fourth-order ODE solver"
      complexity="intermediate"
      tags={["explicit", "O(h4)", "standard"]}
      moduleColor=""
      sections={SECTIONS}
    >
      <TheorySection id="theory" title="Theory">
        <p className="text-slate-300">
          Full lesson content for <strong className="text-white">Runge-Kutta 4</strong> will be implemented here.
