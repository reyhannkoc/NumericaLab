...
export default function Page() {
  return (
    <LessonPageShell
      title="ODE Method Comparison"
      subtitle="Compare ODE solvers on accuracy and phase portrait"
      complexity="advanced"
      tags={["comparison"]}
      moduleColor=""
      sections={SECTIONS}
    >
      <TheorySection id="theory" title="Theory">
        <p className="text-slate-300">
          Full lesson content for <strong className="text-white">ODE Method Comparison</strong> will be implemented here.
