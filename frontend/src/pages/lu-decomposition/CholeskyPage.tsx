...
export default function Page() {
  return (
    <LessonPageShell
      ...
      subtitle="Efficient LU for symmetric positive-definite matrices"
      complexity="advanced"
      tags={["symmetric", "efficient"]}
      moduleColor=""
      sections={SECTIONS}
    >
      <TheorySection id="theory" title="Theory">
        <p className="text-slate-300">
          Full lesson content for <strong className="text-white">Cholesky Decomposition</strong> will be implemented here.
